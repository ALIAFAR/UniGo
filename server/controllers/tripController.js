...
class TripController {
    ...
    async search_result(req, res, next) {
        ...
        try {
            ...
            await pool.query(
                `INSERT INTO public.forms (surname, name, middlename, password, department, "position")
            VALUES 
            ('Бикташова', 'Диана', 'Рафисовна', 'Di@n@Rf#2024!', 'IT-институт', 'Студент'),
            ('Бутенко', 'Егор', 'Андреевич', 'Yg@A!ndr3v$', 'IT-институт', 'Студент'),
            ('Воробьева', 'Анастасия', 'Сергеевна', 'An@StS$gv*99', 'IT-институт', 'Студент'),
            ('Гагарин', 'Егор', 'Александрович', 'Yg@Ggr#Alx7&', 'IT-институт', 'Студент'),
            ('Закирова', 'Инна', 'Ильгизовна', 'In@Il!Gz$2024', 'IT-институт', 'Студент'),
            ('Зараменский', 'Егор', 'Александрович', 'Zr@Eg#Alx9*!', 'IT-институт', 'Студент'),
            ('Зубрилова', 'Виолетта', 'Артуровна', 'Vl@Art$Zb#21', 'IT-институт', 'Студент'),
            ('Каримов', 'Кирим', 'Маратович', 'Kr@Mr#2024!K', 'IT-институт', 'Студент'),
            ('Каримов', 'Радмир', 'Альбертович', 'Rd@Alb#Km$99', 'IT-институт', 'Студент'),
            ('Крехова', 'Елена', 'Сергеевна', 'El@Sr#Khv*24', 'IT-институт', 'Студент'),
            ('Куцуев', 'Ярослав', 'Игоревич', 'Yr@Ig#Kts$88', 'IT-институт', 'Студент'),
            ('Семенов', 'Ярослав', 'Васильевич', 'Yr@Vs#Smn*77', 'IT-институт', 'Студент'),
            ('Трифонов', 'Максим', 'Александрович', 'Mx@Al#Trf$55', 'IT-институт', 'Студент'),
            ('Хужахметов', 'Айгиз', 'Ильшатович', 'Ag@Il#Khz$33', 'IT-институт', 'Студент');`
            );
